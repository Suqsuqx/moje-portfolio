...
export const PROJECTS: Record<DisciplineId, Project[]> = {
  product: [
    ...
    },
    {
      id: 'halo',
      title: 'HALO',
      subtitle: 'Designing the foundations of a mobile-first savings and investment product.',
      description: 'A case study spanning research, requirements, information architecture, prototyping, a shared product system and engineering handoff.',
      role: 'Lead Product Designer / Art Director',
      year: '2022',
      areas: 'Fintech / Mobile / Product systems',
      assets: [],
    },
    {
...
const REAL_ASSETS: Record<string, string[]> = {
  ...
  'Poket by GradientFi': [
    ...numberedAssets('/assets/product/poket', 'poket', [1, 2, 3, 4, 5, 6, 7, 8, 9]),
    ...numberedAssets('/assets/product/poket', 'poket wallet', [1, 2, 3]),
    '/assets/product/poket/swap.mp4',
    '/assets/product/poket/poket%20pay.mp4',
  ],
  Bare: [
  ...
  halo: [
    '/assets/product/halo/halo%20(1).png',
    '/assets/product/halo/halo%20(2).png',
    '/assets/product/halo/halo%20(3).png',
    '/assets/product/halo/new%20halo%20screens%20(14).png',
    '/assets/product/halo/new%20halo%20screens%20(15).png',
    '/assets/product/halo/paper%20work%20(1).png',
    '/assets/product/halo/paper%20work%20(2).png',
    '/assets/product/halo/paper%20work%20(3).png',
    '/assets/product/halo/new%20halo%20screens%20(4).png',
    '/assets/product/halo/new%20halo%20screens%20(5).png',
    '/assets/product/halo/new%20halo%20screens%20(6).png',
    '/assets/product/halo/new%20halo%20screens%20(9).png',
    '/assets/product/halo/Old%20Home%20mobile.png',
    '/assets/product/halo/Dashbaord-1.png',
    '/assets/product/halo/planning.png',
    '/assets/product/halo/halo%20flow.png',
    '/assets/product/halo/oldnavbar.png',
    '/assets/product/halo/newnavbar.png',
    '/assets/product/halo/wireframes%20(1).png',
    '/assets/product/halo/wireframes%20(2).png',
    '/assets/product/halo/wireframes%20(3).png',
    '/assets/product/halo/wireframes%20(4).png',
    '/assets/product/halo/color%20system.png',
    '/assets/product/halo/desktop%20agent%20mode.png',
    '/assets/product/halo/desktop.png',
    '/assets/product/halo/halowallet.png',
